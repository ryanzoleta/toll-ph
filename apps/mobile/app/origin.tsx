  ...
  return (
    <SafeAreaView className="bg-background min-h-screen">
      ...
      <View className="flex flex-1 flex-col pb-16 pt-5">
        <ScrollView>
          <View className="border-t-secondary border-t p-5">
            <Text className="text-foreground text-2xl font-bold">Magallanes</Text>
          </View>
          ...
          <View className="border-t-secondary border-t p-5">
            <Text className="text-foreground text-2xl font-bold">Calamba</Text>
          </View>
        </ScrollView>
      </View>
    </SafeAreaView>
